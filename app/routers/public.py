...
SCREEN_PAGES = {
    "home": {
        "page_title": "Magic Moment - персональные песни в подарок",
        "meta_description": "Magic Moment - персональные песни в подарок. Расскажите историю текстом или голосом, получите 2 варианта текста бесплатно и выберите лучший вариант для готовой песни.",
    ...
    "portfolio": {
        "page_title": "Портфолио - Magic Moment",
        "meta_description": "Портфолио Magic Moment: примеры готовых песен на свадьбу, юбилей, годовщину и личные подарки. Слушайте треки прямо на странице.",
        "eyebrow": "Портфолио",
    ...
    "how": {
        "page_title": "Как это работает - Magic Moment",
        "meta_description": "Как работает Magic Moment: пошаговая анкета, 2 варианта текста песни, личный кабинет, оплата после выбора текста и выдача готового результата.",
     ...
     "reviews": {
        "page_title": "Отзывы клиентов - Magic Moment",
        "meta_description": "Отзывы клиентов Magic Moment: реальные впечатления о песнях на юбилей, свадьбу, годовщину и личные подарки.",
...
LEGAL_PAGES = {
    "offer": {
        "page_title": "Оферта - Magic Moment",
        "meta_description": "Публичная оферта Magic Moment: условия оформления заказа, оплаты и получения персональной песни по истории пользователя.",
        "eyebrow": "Публичная оферта",
        "title": "Условия заказа и оказания услуги",
        "lead": "На этой странице описаны базовые условия оформления заказа в Magic Moment: что входит в услугу, когда происходит оплата и как пользователь получает результат.",
        "updated_at": "Редакция от 14.03.2026",
        "sections": [
            {
                "title": "1. Общие положения",
                "paragraphs": [
                    "Настоящий текст является публичным предложением сервиса Magic Moment оформить заказ на создание персональной песни по истории пользователя.",
            ...
            },
            {
                ...
                "paragraphs": [
                    "Magic Moment предоставляет цифровую услугу по созданию персональной песни на основе информации, которую пользователь передаёт через сайт.",
                ],
                "items": [
            ...
            },
            {
                ...
                "paragraphs": [
                    "Сервис не несёт ответственность за невозможность оказания услуги по причинам, связанным с недостоверными данными пользователя, техническими сбоями внешних платёжных или AI-сервисов, а также перебоями связи и хостинга, которые не зависят от Magic Moment.",
            ...
            },
            {
                "title": "9. Контакты",
                "paragraphs": [
                    "По вопросам заказа, доступа к кабинету и спорным ситуациям пользователь может обратиться через контакты, указанные на сайте Magic Moment.",
                ],
                "bullet_items": [],
            },
        ],
    ...
    "policy": {
        "page_title": "Политика конфиденциальности - Magic Moment",
        "meta_description": "Политика конфиденциальности Magic Moment: какие данные собираются, для чего используются и как обрабатываются в процессе создания персональной песни.",
        "eyebrow": "Политика конфиденциальности",
        "title": "Как Magic Moment работает с данными пользователя",
        "lead": "На этой странице собрана базовая информация о том, какие данные пользователь передаёт через сайт Magic Moment, зачем они нужны и как используются внутри сервиса.",
        "updated_at": "Редакция от 14.03.2026",
        "sections": [
            {
            ...
            },
            {
                ...
                "paragraphs": [
                    "Для выполнения заказа Magic Moment может использовать внешние сервисы и подрядчиков, которые технически участвуют в работе платформы.",
            ...
            },
            {
                ...
                "paragraphs": [
                    "Magic Moment принимает разумные технические меры для защиты данных пользователя от несанкционированного доступа, утраты и случайного удаления.",
            ...
            },
            {
                ...
                "paragraphs": [
                    "Оплата заказа проходит через YooKassa. Magic Moment не хранит полные данные банковских карт пользователя на своей стороне.",
            ...
            },
            {
                ...
                "paragraphs": [
                    "Magic Moment вправе обновлять настоящую политику по мере развития сервиса. Актуальная версия всегда публикуется на этой странице.",
                ],
                "bullet_items": [],
            },
            {
                "title": "8. Контакты",
                "paragraphs": [
                    "По вопросам обработки данных и доступа к заказу пользователь может обратиться через контакты, указанные на сайте Magic Moment.",
                ],
                "bullet_items": [],
            },
        ],
